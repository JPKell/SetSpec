...
dependencies SetSpec is entitled to beyond the suite packages it imports; this reads the
...
# SetSpec.
APPROVED_NON_SUITE_DEPENDENCIES: frozenset[str] = frozenset({"jinja2", "pydantic"})
